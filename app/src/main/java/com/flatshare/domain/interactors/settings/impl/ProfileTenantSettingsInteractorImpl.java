...
//        this.mTenantProfile = tenantProfile;
//    }
//
...
//
//        System.out.println("ID: " + mTenantProfile.getId());
//
//        //String path = databaseRoot.getTenantProfileNode(mTenantProfile.getId()).getRootPath();
//        //mDatabase.child(path).setValue(mTenantProfile);
//
//        notifySuccess();
////
////
